...
export interface ApiAboutSupertextAboutSupertext
...
export interface ApiAiTranslationAiTranslation extends Struct.SingleTypeSchema {
  collectionName: 'ai_translations';
  info: {
    description: '';
    displayName: 'AI Translation';
    pluralName: 'ai-translations';
    singularName: 'ai-translation';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ai-translation.ai-translation'
    >;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'base.seo', false> &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author: Schema.Attribute.Relation<'manyToOne', 'api::author.author'>;
    author_time: Schema.Attribute.Date &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiCaseEntryCaseEntry extends Struct.CollectionTypeSchema {
...
export interface ApiFaqFaq extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faq: Schema.Attribute.Component<'base.faq-category-container', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiWhySupertextWhySupertext extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'Why Supertext';
    pluralName: 'why-supertexts';
    singularName: 'why-supertext';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-supertext.about-supertext': ApiAboutSupertextAboutSupertext;
      'api::ai-translation.ai-translation': ApiAiTranslationAiTranslation;
